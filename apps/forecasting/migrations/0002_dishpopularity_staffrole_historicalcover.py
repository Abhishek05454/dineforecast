    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_orders_percentage', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('waiter', 'Waiter'), ('chef', 'Chef'), ('bartender', 'Bartender'), ('manager', 'Manager'), ('cashier', 'Cashier')], max_length=30, unique=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-date', 'hour'],
                'indexes': [models.Index(fields=['date'], name='forecasting_date_bab6b9_idx'), models.Index(fields=['is_weekend'], name='forecasting_is_week_1eaa74_idx')],
